  ...
  const checkSession = async () => {
    try {
      ...
      if (data.authenticated) {
        // Already logged in, redirect to accounting dashboard
    ...
    <div className="min-h-screen bg-[#212226] flex items-center justify-center p-4 pb-20">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-[#FFE176] mb-2">Accounting System</h1>
          <p className="text-[#E5E5E5]">HMRC-Compliant Bookkeeping</p>
        </div>
